...
def generate_launch_description():
    pkg_share = get_package_share_directory("linear_inverted_pendulum_pid_sim")
    ros_gz_sim_share = get_package_share_directory("ros_gz_sim")

    robot_description_file = os.path.join(
        pkg_share, "urdf", "linear_inverted_pendulum_pid.urdf.xacro"
    )
    ...
    serial_bridge = Node(
        ...
        executable="pid_serial_bridge",
        name="pendulum_pid_serial_bridge",
        output="screen",
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument(
                "serial_link",
                default_value="/tmp/pendulum_pid_serial",
