...
class SimSerialBridge(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter("cart_velocity_limit_mps", 0.90)
        self.declare_parameter("command_accel_limit_mps2", 5.0)
        ...
        self.declare_parameter("swing_damping_gain", 0.28)
        self.declare_parameter("swing_kick_mps", 0.35)
        self.declare_parameter("balance_capture_deg", 10.0)
        self.declare_parameter("balance_capture_rate_rad_s", 2.2)
        self.declare_parameter("balance_fallback_deg", 50.0)
        self.declare_parameter("balance_capture_cart_pos_m", 0.22)
        self.declare_parameter("balance_capture_cart_vel_mps", 0.80)
        self.declare_parameter("catch_region_deg", 35.0)
        self.declare_parameter("catch_region_rate_rad_s", 6.0)
        self.declare_parameter("catch_force_limit_n", 55.0)
        self.declare_parameter("balance_force_limit_n", 55.0)
        ...
        self.declare_parameter("balance_theta_kp", 60.0)
        self.declare_parameter("balance_theta_kd", 14.0)
        ...
        self.declare_parameter("motor_velocity_servo_p", 90.0)
        self.declare_parameter("motor_velocity_servo_d", 4.0)
    ...
    def _swing_up_energy_command_locked(self, theta_top, dt):
        ...
        if centering_force is not None:
            return self._force_to_command_hint(centering_force), None
        ...
        if self._ready_for_balance_locked(theta_top):
            ...
            self.swing_state = "CALC"
            return self._gui_balance_command_locked(theta_top, dt), None
        ...
        return self._force_to_command_hint(force), None
